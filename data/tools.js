...
window.SITE_TOOLS = {
  ...
  weekly: {
    week: "2026-07-27",
    note: "本週精選來自 Product Hunt（GitHub Trending 本週以編碼代理、資安代理等偏工程主題為主；Hugging Face 熱門偏底層模型/論文，均無適合一般使用者的項目，故未列入）",
    items: [
      { name: "Lattics", price: "免費下載/進階功能付費訂閱", desc: "「像大腦一樣運作」的知識管理與寫作工具，結合卡片筆記、視覺化圖表、PDF 翻譯與自動引註", fit: "介面與 Heptabase 類似但更偏學術寫作與文獻管理，適合研究生、寫作者評估是否替代或搭配現有工具", link: "https://lattics.com/en-US" },
      { name: "Deck", price: "14 天免費試用，付費方案未公開", desc: "「自帶信箱」的 AI 助理，把它加入 CC 或轉寄信件就能自動分類、追蹤待辦並定時發送摘要", fit: "⭐ 用 email 互動即可上手，不用學新介面，很適合天天被信件淹沒的上班族", link: "https://www.hellodeck.ai" },
      { name: "Mispher", price: "完全免費（MIT 授權，本機執行）", desc: "Mac 專用語音輸入與 AI 代理工具，可即時聽寫、潤飾文字、翻譯句子，並在本機執行任務（存 Apple Notes、剪貼簿、檔案）", fit: "免費、隱私佳、操作單純，適合想嘗試「語音+AI」工作流又擔心資料上雲的 Mac 使用者；需 Apple Silicon + macOS 26", link: "https://mispher.com" },
      { name: "nudge", price: "首月 $5 美元，之後 $20 美元/月", desc: "把待辦事項丟進去，AI 依睡眠、用餐、健身房與專注時段自動排進一週行事曆", fit: "概念與 Reclaim.ai 類似但更強調「兩秒新增任務」的極簡操作，適合覺得排程規劃太麻煩的人", link: "https://www.producthunt.com/products/nudge-26" },
      { name: "ChatCut", price: "免費(25 點數)/付費 $25 美元/月起", desc: "可在 ChatGPT、桌面版或網頁版使用的 AI 影片剪輯工具，用文字指令生成字幕、配樂、旁白與剪接時間軸", fit: "比傳統剪輯軟體（如 Descript）更口語化，適合想快速做社群短影音又不想學複雜介面的人", link: "https://chatcut.io" },
      { name: "Routine AI", price: "免費試用，付費方案未公開", desc: "主打「工作版 Siri」，可用語音直接安排會議、新增提醒、寫筆記、搜尋知識庫並自動化重複性工作", fit: "適合喜歡用「說」而非打字處理待辦與行程的人，是體驗語音驅動生產力工具的入門選擇", link: "https://www.producthunt.com/products/routine" }
    ]
  },
